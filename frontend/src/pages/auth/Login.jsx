    ...
    <div className="min-h-screen bg-slate-100">
      <div className="px-4 py-6 sm:px-6 sm:py-8">
        <div className="mx-auto grid min-h-[calc(100vh-3rem)] w-full max-w-7xl overflow-hidden rounded-3xl bg-white shadow-lg lg:grid-cols-2">
          <section className="order-2 relative flex flex-col justify-between overflow-hidden bg-linear-to-br from-blue-600 to-blue-800 p-8 text-white sm:p-10 lg:order-1 lg:p-12 auth-fade-in">
