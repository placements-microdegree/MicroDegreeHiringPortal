        ...
        <div className="mb-4 overflow-hidden rounded-xl border border-[#E2E8F0] bg-white">
          <div className="grid grid-cols-1 divide-y divide-[#E2E8F0] text-sm md:grid-cols-4 md:divide-x md:divide-y-0">
            <div className="px-4 py-3 text-slate-700">
              <div className="text-xs uppercase tracking-wide text-slate-500">All Students</div>
              <div className="mt-1 text-lg font-semibold text-slate-900">{mapped.length}</div>
            </div>
            <div className="px-4 py-3 text-slate-700">
              <div className="text-xs uppercase tracking-wide text-slate-500">
                Active ({ACTIVE_WINDOW_DAYS} days)
              </div>
              <div className="mt-1 text-lg font-semibold text-slate-900">{activeStudentsCount}</div>
            </div>
            <div className="px-4 py-3 text-slate-700">
            ...
            <div className="px-4 py-3 text-slate-700">
              ...
              <div className="mt-1 text-lg font-semibold text-slate-900">{filteredRows.length}</div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 gap-3 md:grid-cols-4 xl:grid-cols-5">
          ...
          <div className="flex flex-col gap-2 pt-1 sm:flex-row sm:justify-end md:col-span-4 xl:col-span-5">
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 rounded-lg border border-rose-200 bg-rose-50 px-4 py-2 text-sm font-semibold text-rose-700 transition hover:bg-rose-100 disabled:cursor-not-allowed disabled:opacity-60 sm:min-w-[220px]"
            >
